...
class _CustomerReceivableListState extends State<CustomerReceivableList> {
  ...
  getCustomerReceivable(CustomerController customerController) {
    return Obx(() => customerController.customerReceivables.isEmpty
        ? Container(
        ...
        : ListView.builder(
            ...
            itemBuilder: (context, index) {
              return customerReceivableCard(
                  ...
                  id:customerController.customerReceivables[index].id,
        ...
        child: SizedBox(
          ...
          child: ListTile(
              ...
              title: Row(
                ...
                children: [
                  Text("Ref${DateFormat('yyyyMMdd').format(DateTime.parse(date))}$id", style: const TextStyle(fontSize: 12)),
                  Text(
                    "\$ $remaining",
