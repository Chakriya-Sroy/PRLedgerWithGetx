      ...
      () => Stack(
        children: [
                  ...
                  child: Column(
                    children: [
                      ...
                      Obx(() => CustomTextField(
                            ...
                            validation: register.passwordValidation.toString(),
                            gapHeight: 15,
                            obscureText: true,
                          )),
                      Obx(() => CustomTextField(
                            ...
                            validation:
                                register.confirmPasswordValidation.toString(),
                            gapHeight: 15,
                            obscureText: true,
                          )),
                      Row(
          ...
          if (register.isLoading.value)
            ...
            Container(
              color: Colors.black.withOpacity(0.2), // Semi-transparent black color for the backdrop
              child: Center(
