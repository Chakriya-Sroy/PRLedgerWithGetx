                      ...
                      children: [
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(userController.userCollector.value!.name),
                              SizedBox(
                                height: 50,
                        ...
                        Obx(() => customerController.ListofAssignCustomerToCollector.length==0 ?const Text(
                            "There no customer assign to collector yet"):const Text(
